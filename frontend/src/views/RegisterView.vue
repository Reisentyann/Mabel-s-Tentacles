...
const handleRegister = async () => {
  console.log('[DEBUG] handleRegister called with:', { username: username.value, email: email.value });
  try {
    ...
    console.log('[DEBUG] Registration action completed successfully, attempting auto-login');
    
    // After register, automatically login
    await authStore.loginAction({ username: username.value, password: password.value });
    console.log('[DEBUG] Auto-login successful, redirecting to dashboard');
