...
func New(cfg *config.Config, st repo.Store, mgr *manager.Manager, sink manager.IndexSink) *server.MCPServer {
	...
	tools.RegisterAll(s, tools.Deps{Cfg: cfg, Store: st, Manager: mgr, Sink: sink})
